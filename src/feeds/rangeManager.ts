...
/**
 * Manages the range and provides API to generate range for specified resolution considering all market scenario
 * @class RangeManager
 */
export default class RangeManager extends AbstractCompose<RangeManagerProps>{
     ...
     * @static
     * @member {string} RangeChangeToken
     */
    static RangeChangeToken:string = 'RANGE_CHANGE_TOKEN';
    /**
     * Returns a Rangemanager object
     * @param {RangeManagerProps} props - the properties which will be passed to constructor
     */
    ...
    /**
     * Returns a range for the specified symbol in a descending sequential order
    ...
    /**
     * Initialize the range for a specific resolution
    ...
    /**
     * Clear all range initialized before
     */
    clearAll(){
        this.__requestRange = {};
    }
